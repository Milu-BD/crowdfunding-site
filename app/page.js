...
>
  ...
  <div style={{ fontStyle: "italic", marginBottom: "20px", color: "#333", borderLeft: "4px solid brown", paddingLeft: "15px" }}>
    ...
    <p><strong> আমাদের প্রজেক্টের বাজেট: ৫০,০০০/- (পঞ্চাশ হাজার) টাকা।</strong></p>

    <p>
    আমরা রাসূলুল্লাহ ﷺ এর পক্ষ থেকে আল্লাহর নামে একটি গরুর ভাগে কুরবানী সম্পন্ন করার সিদ্ধান্ত নিয়েছি। কুরবানীকৃত পশুর মাংস থেকে আমরা ২০টি পরিবারকে বন্টন করার পরিকল্পনা করেছি।
    </p>
    <p>
      এই মানবিক প্রজেক্টটি সফলভাবে বাস্তবায়নের জন্য আমরা আপনাদের আন্তরিক সহযোগিতা ও ভালোবাসা কামনা করছি। আপনাদের সামর্থ্য অনুযায়ী যেকোনো ক্ষুদ্র অবদান আমাদের এই লক্ষ্য পূরণে অনেক বড় ভূমিকা পালন করবে।
    </p>

    <p>
      আল্লাহ তা'আলা আমাদের এই প্রচেষ্টাকে কবুল করুন এবং আমাদের সকলকে উত্তম প্রতিদান দান করুন। আমীন।
    </p>
  </div>
